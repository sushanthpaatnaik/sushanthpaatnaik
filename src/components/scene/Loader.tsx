...
export default function Loader() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] bg-background flex items-center justify-center transition-[opacity,clip-path] duration-1000 ease-[cubic-bezier(0.19,1,0.22,1)] ${
        done
          ? "opacity-0 pointer-events-none [clip-path:inset(50%_0%_50%_0%)]"
