  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-6 md:px-10 py-6 flex items-center justify-between pointer-events-none">
      <div className="flex items-center gap-2 pointer-events-auto">
        ...
        <span className="text-sm tracking-[0.3em] uppercase font-medium">Nova</span>
      </div>
      <nav className="hidden md:flex items-center gap-10 text-xs uppercase tracking-[0.25em] text-muted-foreground pointer-events-auto">
        <a href="#" className="hover:text-foreground transition-colors">Story</a>
        <a href="#" className="hover:text-foreground transition-colors">Tech</a>
        <a href="#" className="hover:text-foreground transition-colors">Film</a>
      </nav>
