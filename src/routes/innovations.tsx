...
const items: Item[] = [
  ...
  { title: "Hydrocell", stage: "R&D", domain: "Hydrogen · Fuel Cell", status: "R&D · Bench", metric: "Zero-emission · high power density", body: "Graphene-enhanced hydrogen fuel cell stack for clean mobility and stationary power.", img: imgHydrocell, cutout: cutHydrocell, application: sceneHydrocell, scene: sceneHydrocell, sceneFit: "cover", featured: true },
  { title: "Bitumax", stage: "Pilot", domain: "Infrastructure · Bitumen", status: "Pilot stage", metric: "1.5–2× pavement life", body: "Bitumen additive extending pavement life with major fatigue reduction.", img: imgBitumax, cutout: cutBitumax, application: appBitumax, scene: sceneBitumax, sceneFit: "cover" },
