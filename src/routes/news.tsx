...
// Fixed black ink plus a genuine green accent a filter would shift off-brand
// (invert turns it magenta) — two pre-coloured exports, same pair as /voices,
// shown via the same logo/logoLight graphite/paper split as INK Talks below.
...
export const Route = createFileRoute("/news")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://sushanthpaatnaik.com/news" },
...
const coverage: PressItem[] = [
  ...
  },
  {
    ...
    body: "At seventeen, Sushanth's breath-sensor apparatus drew national attention as a life-changing assistive technology for the physically challenged.",
  ...
  },
  {
    ...
    body: "An 'Unknown Wizards' feature spotlighting Sushanth's portfolio of inventions and the social impact of his assistive and clean-tech innovations.",
  ...
  },
  {
    ...
    body: "An encyclopedic entry on the Odia Wikipedia chronicling Sushanth Paatnaik's life, innovations and recognitions.",
  ...
  },
  {
    ...
    body: "The New Indian Express profiles a young Sushanth Paatnaik on his determination to channel honours into a foundation that supports under-resourced innovators across India.",
  ...
  },
  {
    ...
    body: "YourStory's company profile of Capattery, the deep-tech venture co-founded by Sushanth Paatnaik, building patent-pending graphene nanomaterials for next-generation Battery Energy Storage Systems.",
  ...
  },
  {
    ...
    body: "INK Talks features Sushanth as a young innovator helping differently-abled individuals through breakthroughs like the Breathing Sensor Apparatus.",
...
const outlets: { name: string; logo: string; logoLight?: string; lighten?: boolean; scale?: number; transparentBg?: boolean; tone?: "muted" | "lift"; nudgeY?: number }[] = [
  ...
  { name: "NIF India",              logo: nifLogo,               logoLight: nifLogoLight, scale: 1.46 },
