...
const gateways = [
  { href: "/about", n: "I", label: "About", line: "Founder, philosophy, journey." },
  { href: "/innovations", n: "II", label: "Innovations", line: "Graphene, materials, systems." },
  { href: "/ventures", n: "III", label: "Ventures", line: "Five operating companies. One stack." },
  { href: "/recognitions", n: "IV", label: "Recognitions", line: "Six Presidential awards. TED. MIT TR." },
  { href: "/essays", n: "V", label: "Essays", line: "Notes from the workshop." },
  { href: "/engage", n: "VI", label: "Engage", line: "Partnerships, advisory, and origin archive." },
  { href: "/news", n: "VII", label: "News", line: "Editorial archive." },
] as const;
